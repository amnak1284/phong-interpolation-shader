...
class Vector3 {
   ...
   static cross(other1, other2) {
    ...
    magnitude() {
        // Insert your code here.
        let n = (this.elements[0]* this.elements[0])+ (this.elements[1]* this.elements[1] + (this.elements[2]*this.elements[2]));

        let m = Math.sqrt(n); // Modify this line to calculate this vector's magnitude.
